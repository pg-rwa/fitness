  ...
  return (
    <SafeAreaView className="flex-1 bg-dark">
      <View className="px-5 pt-2">
        <Text className="text-white text-2xl font-bold mb-4">My Clients</Text>
      ...
      <FlatList
        ...
        ListEmptyComponent={<EmptyState icon="people-outline" title="No clients yet" message="Invite clients to get started" />}
      />
    </SafeAreaView>
  );
}
